    ...
    return Commands.run(
            () -> {
                ...
                if (aimButton.get()) {
                    ...
                    // Remove this if your shooter faces forward
                   Rotation2d targetAngle =
        aimTargetSupplier.get()
                .minus(robotPosition)
                .getAngle();
                    ...
                    double rawOmega = MathUtil.applyDeadband(
                    ...
                    // Prevent old aim target from affecting next use
