...
/**
 * Represents an IO wrapper for vision localizer to query. This class is
...
public interface VisionIO {
	...
	public static class VisionIOInputs {
		...
		public SingleTagObservation latestSingleTagObservation = new SingleTagObservation(0, 0, 0, new Rotation2d(),
				new Rotation2d());
